...
- Generate NewsWeb watchlist rows and the 24-hour digest during scheduled/manual
  Actions runs.
- Start watchlist editing with either a GitHub web-editor link or a draft/export
  diff helper; do not put GitHub write tokens in public JavaScript.
...
- Decide whether generated JSON should be committed or published only as Pages
  build artifacts.
